...
const Chat2 = () => {
    ...
    return (
        <div className="container-fluid">
            ...
            <div class="grid">
                <div> <select value={requestType} onChange={(e) => setRequestType(e.target.value)}>
                    <option value="">Request</option>
                    <option value="Recommend">Recommend</option>
                    <option value="Describe">Describe</option>
                </select>
                </div>
                <div><select value={dressType} onChange={(e) => setDressType(e.target.value)}>
                ...
                <div><select value={occasion} onChange={(e) => setOccasion(e.target.value)}>
                    <option value="">Occasion</option>
                    <option value="Haldi">Haldi Ceremony</option>
                    <option value="Wedding">Wedding</option>
                </select></div>
                <div><select value={primaryColor} onChange={(e) => setPrimaryColor(e.target.value)}>
